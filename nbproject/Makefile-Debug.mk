...
OBJECTFILES= \
	...
	${OBJECTDIR}/src/MessageHandler.o \
...
${OBJECTDIR}/src/MessageHandler.o: src/MessageHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessageHandler.o src/MessageHandler.cpp

${OBJECTDIR}/src/User.o: src/User.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/User.o src/User.cpp
